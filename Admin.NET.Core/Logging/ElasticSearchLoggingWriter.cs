...
public class ElasticSearchLoggingWriter : IDatabaseLoggingWriter
{
    ...
    public async void Write(LogMessage logMsg, bool flush)
    {
        ...
        var log = new SysLogOp
        {
            ...
            RemoteIp = loggingMonitor.remoteIPv4,
            Location = ipLocation,
            Longitude = longitude,
            Latitude = latitude,
            Browser = loggingMonitor.userAgent, // loggingMonitor.userAgent,
        ...
        var resp = await _esClient.IndexDocumentAsync(log);
    }
    /// <summary>
    /// 解析IP地址
    /// </summary>
