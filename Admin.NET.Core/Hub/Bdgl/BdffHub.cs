...
[MapHub("BdffHub")]
public class BdffHub : Hub<IBdffHub>
{
    // 保存连接的客户端id集合
    public static HashSet<string> Users = new HashSet<string>();
    private readonly IHubContext<BdffHub, IBdffHub> _bdffHubContext;

    public BdffHub(IHubContext<BdffHub, IBdffHub> bdffHubContext)
    {
    ...
    {
        // queryBdff为前台注册的方法
        _bdffHubContext.Clients.All.QueryBdff();
    }
