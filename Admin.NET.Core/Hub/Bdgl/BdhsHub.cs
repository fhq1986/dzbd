...
[MapHub("BdhsHub")]
public class BdhsHub : Hub<IBdffHub>
{
    // 保存连接的客户端id集合
    public static HashSet<string> Users = new HashSet<string>();
    private readonly IHubContext<BdhsHub, IBdffHub> _bdffHubContext;

    public BdhsHub(IHubContext<BdhsHub, IBdffHub> bdffHubContext)
    {
    ...
    public void Send()
    {
        _bdffHubContext.Clients.All.QueryBdhs();
    }
